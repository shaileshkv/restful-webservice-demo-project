...
/**
 * Simple resource which does only send back what it gets.
 * 
 * @author Omnaest
 */
@Path("ResourceAccessorPathParam/{key}")
@Produces(MediaType.TEXT_PLAIN)
@Consumes(MediaType.TEXT_PLAIN)
public interface ResourceAccessorPathParam
{
  /**
   ...
   */
  @DELETE
  public void clearValue( @PathParam("key") String key );
}
